...
const welcomeTypes = ["Good morning traveller of the web. Welcome to my website!", "Good afternoon traveller of the web. Welcome to my website!", "Good evening traveller of the web. Welcome to my website!"];
let welcomeText = "";
